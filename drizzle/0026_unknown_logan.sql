...
--> statement-breakpoint
ALTER TABLE "project_collaborators" DROP CONSTRAINT "project_collaborators_user_id_users_id_fk";
--> statement-breakpoint
ALTER TABLE "project_collaborators" DROP CONSTRAINT "project_collaborators_project_id_projects_id_fk";
--> statement-breakpoint
