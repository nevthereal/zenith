...
<EventDemo />
<section class="prose-h1:heading-main prose-h2:heading-sub prose mx-auto mb-16 mt-2">
	<figure class="mb-16 text-center text-sm">Event generation demo</figure>
	...
	<p>
		...
		OpenAI bill, I have set the amount of requests to 10 per hour.
	</p>
	<p>
